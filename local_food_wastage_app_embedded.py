...
load_embedded_data_to_db()
    ...
    providers.to_csv(f"{DATA_DIR}/providers_data.csv", index=False)
    receivers.to_csv(f"{DATA_DIR}/receivers_data.csv", index=False)
    food_listings.to_csv(f"{DATA_DIR}/food_listings_data.csv", index=False)
    claims.to_csv(f"{DATA_DIR}/claims_data.csv", index=False)
...
def load_embedded_data_to_db():
    ...
    for file, table in [
        ...
        ("food_listings_data.csv", "FoodListings"),
